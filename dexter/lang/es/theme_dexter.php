...
$string['choosereadme'] = 'Dexter es un tema moderno altamente personalizable. Este tema está basado en el tema de Moodle: BambuCo.';
...
$string['privacy:metadata'] = 'El tema Dexter no almacena ningún dato personal sobre ningún usuario.';
