...
/**
 * A login page layout for the Dexter theme.
 *
...
$loginmorecontent = get_config('theme_dexter', 'loginmorecontent');
...
echo $OUTPUT->render_from_template('theme_dexter/login', $templatecontext);
