...
/**
 * A drawer based layout for the Dexter theme.
 *
...
$templatecontext = [
    ...
    'coursefooter' => \theme_dexter\utils::get_coursefooter($PAGE->course),
    'courseheaderintop' => $config->coursesheaderposition == 'top',
    'courseheaderincontent' => $config->coursesheaderposition == 'content',
];

echo $OUTPUT->render_from_template('theme_dexter/drawers', $templatecontext);
